...
In computing parallel-left-fold in this manner, some of the partial sums that constitute the output of parallel-prefix-sums are computed.

%%figure illustrating this fact%%
